const CACHE_NAME = 'cache-v80'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v80',
    'estilos/styles.css?v80',
    'estilos/mediaQueries.css?v80',
    'javascript/script.js?v80',
